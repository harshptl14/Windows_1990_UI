                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          width: 50,
                          child: Tab(
                            icon: new Image.asset("images/rename.png"),
                            //iconMargin: EdgeInsets.all(4),
                          ),
                        ),
                        Container(
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        width: 60,
                        child: Tab(
                          icon: new Image.asset("images/mediaServer.png"),
                          //iconMargin: EdgeInsets.all(4),
                        ),
                      ),
                      Container(
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        width: 60,
                        child: Tab(
                          icon: new Image.asset("images/mapNetwork.png"),
                          //iconMargin: EdgeInsets.all(4),
                        ),
                      ),
                      Container(
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        width: 60,
                        child: Tab(
                          icon: new Image.asset("images/addNetwork.png"),
                          //iconMargin: EdgeInsets.all(4),
                        ),
                      ),
                      Container(
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              //width: 60,
                              child: Tab(
                                icon: new Image.asset("images/unistall.png"),
                                //iconMargin: EdgeInsets.all(4),
                              ),
                            ),
                            Container(
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              //width: 60,
                              child: Tab(
                                icon: new Image.asset("images/systemproperty.png"),
                                //iconMargin: EdgeInsets.all(4),
                              ),
                            ),
                            Container(
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              //width: 60,
                              child: Tab(
                                icon: new Image.asset("images/manage.png"),
                                //iconMargin: EdgeInsets.all(4),
                              ),
                            ),
                            Container(
