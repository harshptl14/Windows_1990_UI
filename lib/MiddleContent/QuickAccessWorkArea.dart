            ...
            thispcFolder == true
                ? Container(
                    ...
                    child: Column(
                      children: [
                        mycomputer(
                            context, 'images/desktoppp.png', 'Desktop', 20),
                        mycomputerr(
                            context, 'images/downloadfolder.png', 'Downloads', 20),
                        mycomputerr(
                            context, 'images/document.png', 'Documents', 20),
                        mycomputer(
                            context, 'images/image.png', 'Pictures', 20),
                        mycomputer(
                            context, 'images/video.png', 'Videos', 20),
                      ],
                    ),
                  )
                : Container(),
