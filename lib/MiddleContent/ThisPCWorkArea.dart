                      ...
                      children: [
                        Container(
                          ...
                          children: [
                            ...
                            mycomputer(context, 'images/desktopfolder.png', 'Desktop'),
                            SizedBox(
                              width: 35,
                            ),
                            mycomputer(context, 'images/docfolder.png', 'Documents'),
                            SizedBox(
                              width: 35,
                            ),
                            mycomputer(context, 'images/music.png', 'Music'),
                            SizedBox(
                              width: 35,
                            ),
                            mycomputer(context, 'images/image.png', 'Pictures'),
                            SizedBox(
                              width: 35,
                            ),
                            mycomputer(context, 'images/video.png', 'Videos'),
                            SizedBox(
                              width: 35,
                            ),
                          ],
                        ...
                        Container(
                          child: Row(
                            children: [
                              ...
                              mycomputer(
                                  context, 'images/downloadfolder.png', 'Downloads'),
                              SizedBox(
                                width: 35,
                              ),
                              // mycomputer(
                ...
                ? Container(
                    ...
                    child: Container(
                      ...
                      children: [
                        ...
                        mycomputer(context, 'images/cdrive.png', 'Windows(C:)'),
                        SizedBox(
                          width: 35,
                        ),
                      ],
